...
class MediaBrowserViewController: UIViewController {
    ...
    var dataDictionary: [String: Array<PHAsset>]!
    ...
    public init(showByViewController presentingVC: UIViewController, delegate: MediaBrowserViewControllerDelegate, data: [String: Array<PHAsset>]!, keysSequence: [String]!) {
...
//        if lastCell != nil {
//            let last = lastCell as? VideoBrowserCell
//            last?.stopPlayer()
//        }
        lastCell = cell
    }
