...
class MediaBrowserCollectionViewDataSource: NSObject, UICollectionViewDataSource {
    ...
    init(data: [String: Array<PHAsset>], keysSequence: [String], owner: MediaBrowserViewController?) {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let asset = dataDictionary[keysSequence[indexPath.section]]![indexPath.item]
